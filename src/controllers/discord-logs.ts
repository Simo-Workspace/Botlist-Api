...
export async function log(req: Request, res: Response, next: NextFunction) {
    ...
    const { data } = await axios.post(`https://discord.com/api/v10/webhooks/1125236689485435011/${WEBHOOK_TOKEN}`, { content: "alguém usou a api", username: "ur mom", avatar_url: unrealAvatar }, { headers: { Authorization: `Bot ${CLIENT_TOKEN}` } });
